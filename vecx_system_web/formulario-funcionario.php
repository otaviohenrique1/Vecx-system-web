<?php
    ...
    $paginaVariavel = "formulario-funcionario";
...
<form action="adiciona-funcionario.php" method="post">
    ...
    <div class="col-md-12 form-row">
        <div class="col-md-6 form-group">
            ...
            <input type="text" name="carteira_trabalho" id="c_carteira_trabalho" class="form-control">
            <?php Mensagem::colocaMensagemDeSessaoNaTela('carteira_trabalho_vazio', "danger"); ?>
        </div>
        <div class="col-md-6 form-group">
            <label for="c_salario">Salario</label>
            <input type="number" name="salario" id="c_salario" class="form-control">
