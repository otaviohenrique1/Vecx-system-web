<?php
    ...
    //     header("Location: ficha-produto.php");
    //     die();
    // } else {
        $url = "formulario-altera-produto.php";
        ...
        if ($produtoDao->alteraProduto($produto)) {
            ...
            echo "<a href='lista-produto.php' class='btn btn-primary'c>Voltar</a>";
        }
    // }
